...
const EventCard = ({event , handlViewDetails}) => {
    ...
    return (
        <div key={event.id} className="bg-neutral-900 w-100 rounded-xl border border-neutral-800 shadow-lg hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 ease-in-out flex flex-row overflow-hidden">
